...
dependencies {
	implementation("org.bread_experts_group:bread_server_lib-code:2.11.2")
}
...
publishing {
	publications {
		...
		create<MavenPublication>("mavenKotlin") {
			...
			pom {
				name = "Domain Name System resolver client"
				description = "Distribution of software for Bread Experts Group resolver clients for DNS."
				...
				scm {
					connection = "scm:git:git://github.com/Bread-Experts-Group/dns_microclient.git"
					developerConnection = "scm:git:ssh://git@github.com:Bread-Experts-Group/dns_microclient.git"
					url = "https://javart.zip"
				}
			}
		}
